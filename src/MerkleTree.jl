...
function MerkleTree(total::Integer)
    ...
    nodes = Array{Union{Nothing, Array{UInt8,1}},1}[]
...
"""
    set_current_node!(tree::MerkleTree, value::Array{UInt8,1})
    -> Nothing

Set `value` to current node
"""
function set_current_node!(tree::MerkleTree, value::Array{UInt8,1})
